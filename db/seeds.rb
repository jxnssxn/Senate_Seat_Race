User.create!([
  # {first_name: "al pastor", last_name: "taco", email: "alpastor@taco", age: 1, gender: "F", party_registered_to: "Dem", county: "chalupa", race: "mexican", ethnicity: "tacos", post_id: 2, password_digest: "$2a$12$yz3Ud1XgCouL4DlO6CL8GOuw8jTa4C7YGxvF0cL37iRU07L3Zlhji", image: },
  {first_name: "ham", last_name: "pizza", email: "ham@pizza.com", age: 1, gender: "M", party_registered_to: "Dem", county: "napoli", race: "pizza", ethnicity: "pie", post_id: 3, password_digest: "$2a$12$.UU7569dJLBgg.TSCsYDyu1Smy.ZuSO5B9wEzKdSRN81kcUIQ8isW", image: },

  {first_name: "Carlisle", last_name: "horton", email: "carlisle@carl.com", age: 22, gender: "M", party_registered_to: "Democrat", county: "Fulton", race: "american indian", ethnicity: "latino", post_id: , password_digest: "$2a$12$wPJwSkv7YxT6iNFQlS0Diu99V8l.MfTG.eFmQmKLBHY/79efbvCi.", image: "app/assets/images/man-wearing-brown-jacket-using-smartphone-while-using-smartphone-stockpack-pexels-scaled-e1594250865187.jpg"},
  ...
  # {first_name: , last_name: , email: "Kelli@kelli.com", age: , gender: , party_registered_to: , county: , race: , ethnicity: , post_id: , password_digest: "$2a$12$vRtp3DOwww8.vA8l7QDTYeh4pNMKgTUclaxFffZJExdUy3B2w7Idy", image: },

  # {first_name: , last_name: , email: "neverimpeached@carter.com", age: , gender: , party_registered_to: , county: , race: , ethnicity: , post_id: , password_digest: "$2a$12$rfc5sDQNE5P7nCsTOBhSluuFTGP1AMCwolWEenGiLT2uZPi/EkVA.", image: nil}
])
Candidate.create!([
