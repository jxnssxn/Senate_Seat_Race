...
# # ------------{{Candidate create}}------------
# Candidate.create(
# first_name: "Raphael G.", last_name: "Warnock", email: "info@warnock.com", age: 51, gender: "M", party_registered_to: "Democrat", issues_id: 1, thumbs_up: 53, thumbs_down: 3, image: "app/assets/images/merlin_181303653_2b7838a4-b24f-4153-8012-00d6873a8f4f-articleLarge.jpg"
# )
# Candidate.create(
# first_name: "Jon", last_name: "Ossoff", email: "info@electjon.com", age: 33, gender: "M", party_registered_to: "Democrat", issues_id: 2, thumbs_up: 49,thumbs_down: 3, image: "app/assets/images/GettyImages1282925380-054e2750-7aab-433c-b456-f5e5d03f5da6.jpg"
# )
# Candidate.create(
#   first_name: "David", last_name: "Perdue", email: "info@perdue.gov", age: 70, gender: "M", party_registered_to: "Republican", issues_id:3, thumbs_up: 12, thumbs_down:30, image: "app/assets/images/GettyImages-1229608616.jpg"
# )
# Candidate.create(
# first_name: "Kelly", last_name: "Leoffler", email: "info@k.loeffler.gov", age:50, gender: "F", party_registered_to: "Republican", issues_id: 4, thumbs_up: 12, thumbs_down: 33, image: "app/assets/images/im-269161.jpeg"
# )
# ------------{{Issues create}}------------
Issue.create!(
